...
public struct Constants {
    public static let formatPickerDB: [String: String] = [
        ...
        "radio1.title": NSLocalizedString("Org Mode",
                                          bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
                                          comment: "Org Mode selection for format picker"),
        "radio2.title": NSLocalizedString("Markdown",
                                          bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
        ...
        "radio1.toolTip": NSLocalizedString("Use Org Mode format",
                                            bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
                                            comment: "Tool tip for Org Mode format selection"),
        "radio2.toolTip": NSLocalizedString("Use Markdown format",
                                            bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
    ...
    public static let transmitPickerDB: [String: String] = [
        ...
        "radio1.title": NSLocalizedString("Org Protocol",
                                          bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
                                          comment: "Org Protocol selection for transmit picker"),
        "radio2.title": NSLocalizedString("Clipboard",
                                          bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
        ...
        "radio1.toolTip": NSLocalizedString("Use Org Protocol to share",
                                            bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
                                            comment: "Tool tip for Org Protocol selection"),
        "radio2.toolTip": NSLocalizedString("Use Clipboard to share",
                                            bundle: Bundle(identifier: "com.yummymelon.CapteeKit") ?? Bundle.main,
